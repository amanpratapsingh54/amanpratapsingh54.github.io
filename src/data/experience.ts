...
export const experience: ExperienceItem[] = [
  {
    ...
    techStack: ["LLMs", "RAG", "Embeddings", "Clustering", "Cybersecurity", "Python"],
    impact: [
      "Developed an LLM/RAG-assisted anomaly detection pipeline for temporal cybersecurity streams, combining embeddings, retrieval, dimensionality reduction, and clustering.",
      "Evaluated precision and recall@5 on 5k+ events, improved suspicious-pattern triage by 13%, and mentored 30+ graduate students.",
    ],
  },
  {
    role: "ML Engineer",
    ...
    techStack: ["LLaMA-2 7B", "QLoRA", "DeepSpeed", "RAG", "FAISS", "LangChain", "FastAPI", "XGBoost"],
    impact: [
      "Fine-tuned LLaMA-2 7B on 60K financial Q&A pairs using QLoRA and DeepSpeed; improved Recall@3 from 43% to 59% on a 500-query held-out set.",
      ...
      "Built a portfolio analytics dashboard backed by a SARIMAX-XGBoost ensemble for 7-day return forecasting; achieved 6.2% MAPE across 50 equities.",
  ...
  },
  {
    ...
    techStack: ["Dialogflow", "WhatsApp Business API", "Google My Business", "ResNet", "RNN", "Python"],
    impact: [
